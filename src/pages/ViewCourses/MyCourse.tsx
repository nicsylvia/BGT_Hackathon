      ...
      <Main>
        ...
        <Buttom>
          ...
          <Hold>
            ...
            <Desc>
              JavaScript's most popular use is for web development, and it is
              one of the most powerful tools a developer can have on their
              toolbelt. Developers use JavaScript in web development to add
              interactivity and features to improve the user experience and make
              the internet much more enjoyable.
            </Desc>
          </Hold>
          <Hold>
            <Explain>Summary Of JavaScript</Explain>
            <Desc>
              JavaScript Developer is a booming career, and those looking to
              make a career in JavaScript have lucrative prospects. Some of the
              top JavaScript Job roles include: Front end web developer, Web
              application developer, Website administrator, Full Stack
              Developer, Quality Assurance Automation, Specialist, Web Marketing
              manager
            </Desc>
          </Hold>
        </Buttom>
        ...
        <Desc2>
          ...
          <CourseName2>
            I love teaching, just follow me up to learn more
          </CourseName2>
          <Link to="/game">
            <Button>Take a Quiz</Button>
          </Link>
